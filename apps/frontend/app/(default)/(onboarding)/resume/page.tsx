    ...
    <BackgroundContainer innerClassName="justify-start pt-16">
      <div className="w-full max-w-2xl mx-auto flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center gap-6">
          <h1 className="text-4xl font-bold text-center text-white mb-6">Upload Your Resume</h1>
          <p className="text-center text-gray-300 mb-8 max-w-xl">
            Drag and drop your resume file below or click to browse. Supported formats: PDF, DOC,
            DOCX (up to 2 MB).
          </p>
