        ...
        <div className="mb-8">
          ...
          {workExperience.map((exp) => (
            <div key={exp.id} className="mb-5 pl-4 border-l-2 border-blue-500">
              ...
              {exp.title && <h4 className="text-lg font-semibold text-gray-100">{exp.title}</h4>}
        ...
        <div className="mb-8">
          ...
          {education.map((edu) => (
            <div key={edu.id} className="mb-5 pl-4 border-l-2 border-green-500">
              ...
              {edu.institution && (
                <h4 className="text-lg font-semibold text-gray-100">{edu.institution}</h4>
              )}
              {/* Adjusted gray for degree */}
              {edu.degree && <p className="text-md font-medium text-gray-400">{edu.degree}</p>}
              {/* Adjusted gray for dates */}
        ...
        <div className="mb-8">
          ...
          {personalProjects.map((project) => (
            <div key={project.id} className="mb-5 pl-4 border-l-2 border-purple-500">
              ...
              {project.role && <p className="text-md font-medium text-gray-400">{project.role}</p>}
